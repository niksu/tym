...
OBJ_FILES=ast.o buffer.o formula.o statement.o symbols.o translate.o
OBJ=$(addprefix $(OUT_DIR)/, $(OBJ_FILES))
OBJ_OF_TGT=$(OUT_DIR)/main.o
HEADER_FILES=ast.h buffer.h formula.h lifted.h statement.h symbols.h translate.h util.h
HEADER_DIR=include
