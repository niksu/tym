  ...
  struct TymProgram * ParsedQuery)
{
  ...
  printf("enum TymReturnCodes\n");
  printf("apply (enum TymReturnCodes (*meta_program)(struct TymParams * Params, struct TymProgram * program, struct TymProgram * query), struct TymParams * Params)\n");
  printf("{\n");
