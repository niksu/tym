...
struct TymBufferWriteResult * tym_term_to_str(const struct TymTerm * const term, struct TymBufferInfo * dst);
struct TymBufferWriteResult * tym_terms_to_str(const struct TymTerms * const terms, struct TymBufferInfo * dst);
struct TymBufferWriteResult * tym_predicate_to_str(const struct TymAtom * atom, struct TymBufferInfo * dst);
struct TymBufferWriteResult * tym_atom_to_str(const struct TymAtom * const atom, struct TymBufferInfo * dst);
struct TymBufferWriteResult * tym_clause_to_str(const struct TymClause * const clause, struct TymBufferInfo * dst);
struct TymBufferWriteResult * tym_program_to_str(const struct TymProgram * const program, struct TymBufferInfo * dst);
...
typedef struct TymBufferWriteResult * (*tym_x_to_str_t)(void *, struct TymBufferInfo * dst);

void tym_debug_out_syntax(void * x, struct TymBufferWriteResult * (*tym_x_to_str)(void *, struct TymBufferInfo * dst));
