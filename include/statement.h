...
struct TymBufferWriteResult * stmts_str(const struct stmts_t * const, struct TymBufferInfo * dst);
...
struct TymBufferWriteResult * model_str(const struct model_t * const, struct TymBufferInfo * dst);
