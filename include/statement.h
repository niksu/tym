...
struct buffer_write_result * stmts_str(const struct stmts_t * const, struct buffer_info * dst);
...
struct buffer_write_result * model_str(const struct model_t * const, struct buffer_info * dst);
